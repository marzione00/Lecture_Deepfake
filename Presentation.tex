...
\begin{frame}{Reti neurali \cite{pml1Book,classification_datacamp}}
...
\begin{frame}{Reti neurali \cite{pml1Book}}
\begin{columns}
\begin{column}{0.5\textwidth}
...
\begin{frame}{Modelli generativi \cite{google_generativeIA,pml1Book}}
\begin{columns}
\begin{column}{0.5\textwidth}
...
\begin{frame}{Modelli generativi \cite{pml1Book}}
\begin{center}
\includegraphics[width=0.7\textwidth]{Pic/generative_models.png}
\end{center}
\end{frame}

\begin{frame}{Modelli generativi: esempi \cite{pml1Book}}
\begin{center}
...
\begin{frame}{Variational autoencoders \cite{pml1Book}}
\begin{columns}
\begin{column}{0.5\textwidth}
\begin{alertblock}{Modello generativo}
Un modello generativo descrive come viene generato un set di dati utilizzando un modello probabilistico $(p(x)\quad x\in X)$. Campionando da questo modello, siamo in grado di generare nuovi dati.
